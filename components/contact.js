...
export default function ContactPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can schedule a consultation by filling out the contact form on this page, calling us at 0731 252 5381, or emailing us at b_bansal@outlook.com. We offer a free initial consultation to discuss your needs."
    },
    {
        question: "What are your business hours?",
        answer: "Our office is open from Monday to Saturday, 10:00 AM to 6:00 PM. We are closed on Sundays and public holidays."
    },
    {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    {[
                      ...
                      { 
                        ...
                        lines: [
                          ...
                          <a
                            key="email2"
                            href="mailto:b_bansal@outlook.com"
                            className="text-black hover:text-blue-600 transition-colors duration-200"
                          >
                            b_bansal@outlook.com
                          </a>
                        ] 
                      },
                      { icon: "🕒", title: "Business Hours", lines: ["Monday - Saturday: 10:00 AM - 6:00 PM", "Sunday: Closed"] }
                    ].map((item, index) => (
              ...
              <div>
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 hover:border-black">
                  ...
                  <form action="https://formsubmit.co/rayabhishek20112000@gmail.com" method="POST" className="space-y-6">
                    <div>
